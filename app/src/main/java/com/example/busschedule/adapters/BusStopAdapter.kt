...
//class to takes a list of schedule objects and a BusStopViewHolder class for the UI
class BusStopAdapter(private val onItemClicked: (Schedule) -> Unit) : ListAdapter<Schedule, BusStopAdapter.BusStopViewHolder>(DiffCallback) {
    ...
    companion object {
        ...
        //DiffCallBack helps ListAdapter determine which items in the new and old list are different when updating the list.
